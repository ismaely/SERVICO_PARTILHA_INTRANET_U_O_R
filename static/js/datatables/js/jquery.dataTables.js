! function(e, a, t) {
  ! function(e) {
    ...
    function s(e) {
      var a, t, o = "a aa ao as b fn i m o s ",
        l = {};
      n.each(e, function(n) {
    ...
    function r(e, s) {
      var o = Ra.defaults.column,
        l = e.aoColumns.length,
        r = n.extend({}, Ra.models.oColumn, o, {
      ...
      if (e.aoColumns.push(r), e.aoPreSearchCols[l] === t || null === e.aoPreSearchCols[l]) e.aoPreSearchCols[l] = n.extend({}, Ra.models.oSearch);
      else {
    ...
    function i(e, a, s) {
      ...
      var r = l.mRender ? _(l.mRender) : null,
        i = _(l.mData);
        ...
        for (o = a.length - 1; o >= 0; o--) {
          ...
          for (n.isArray(f) || Ia(e, 1, "aTargets must be an array of targets, not a " + typeof f), i = 0, u = f.length; u > i; i++)
            if ("number" == typeof f[i] && f[i] >= 0) {
              ...
              s(f[i], a[o])
            } else if ("number" == typeof f[i] && f[i] < 0) s(e.aoColumns.length + f[i], a[o]);
          else if ("string" == typeof f[i])
            for (d = 0, c = e.aoColumns.length; c > d; d++)("_all" == f[i] || n(e.aoColumns[d].nTh).hasClass(f[i])) && s(d, a[o])
        }
      if (t)
        for (o = 0, l = t.length; l > o; o++) s(o, t[o])
    }

    function S(e, a, t, s) {
      var o, l = e.aoData.length,
        r = n.extend(!0, {}, Ra.models.oRow);
    ...
    function v(e, a, n, s) {
      ...
      if (null === r && null !== o.sDefaultContent) r = o.sDefaultContent;
    ...
    function F(e, a) {
      for (var t = -1, n = 0, s = e.length; s > n; n++) e[n] == a ? t = n : e[n] > a && e[n]--; - 1 != t && e.splice(t, 1)
    }

    function A(e, t, n, s) {
      var o, l, r, i, u, d = e.aoData[t],
        c = d._aData;
      if (null === d.nTr) {
    ...
    function P(e) {
      ...
      if (0 !== l)
        for (t = 0, o = e.aoColumns.length; o > t; t++) s = e.aoColumns[t].nTh, s.setAttribute("role", "columnheader"), e.aoColumns[t].bSortable && (s.setAttribute("tabindex", e.iTabIndex), s.setAttribute("aria-controls", e.sTableId)), null !== e.aoColumns[t].sClass && n(s).addClass(e.aoColumns[t].sClass), e.aoColumns[t].sTitle != s.innerHTML && (s.innerHTML = e.aoColumns[t].sTitle);
      else {
      ...
      if (e.oFeatures.bSort)
        for (t = 0; t < e.aoColumns.length; t++) e.aoColumns[t].bSortable !== !1 ? Da(e, e.aoColumns[t].nTh, t) : n(e.aoColumns[t].nTh).addClass(e.oClasses.sSortableNone);
    ...
    function N(e) {
      ...
      var o, l, r, i = [],
        u = 0,
        d = e.asStripeClasses.length,
        c = e.aoOpenRows.length;
      if (e.bDrawing = !0, e.iInitDisplayStart !== t && -1 != e.iInitDisplayStart && (e._iDisplayStart = e.oFeatures.bServerSide ? e.iInitDisplayStart : e.iInitDisplayStart >= e.fnRecordsDisplay() ? 0 : e.iInitDisplayStart, e.iInitDisplayStart = -1, na(e)), e.bDeferLoading) e.bDeferLoading = !1, e.iDraw++;
      ...
      var T, _ = a.createDocumentFragment(),
        x = a.createDocumentFragment();
      if (e.nTBody) {
        if (T = e.nTBody.parentNode, x.appendChild(e.nTBody), !e.oScroll.bInfinite || !e._bInitComplete || e.bSorted || e.bFiltered)
          for (; r = e.nTBody.firstChild;) e.nTBody.removeChild(r);
    ...
    function E(e) {
      ...
      for (var t, s, o, l, r, i, u, d = e.nTableWrapper, c = e.sDom.split(""), f = 0; f < c.length; f++) {
        if (s = 0, o = c[f], "<" == o) {
          ...
          d.appendChild(l), d = l
        } else if (">" == o) d = d.parentNode;
        else if ("l" == o && e.oFeatures.bPaginate && e.oFeatures.bLengthChange) t = ta(e), s = 1;
        else if ("f" == o && e.oFeatures.bFilter) t = J(e), s = 1;
        else if ("r" == o && e.oFeatures.bProcessing) t = la(e), s = 1;
        else if ("t" == o) t = ia(e), s = 1;
        else if ("i" == o && e.oFeatures.bInfo) t = z(e), s = 1;
        else if ("p" == o && e.oFeatures.bPaginate) t = sa(e), s = 1;
    ...
    function H(e, a) {
      var t, s, o, l, r, i, u, d, c, f, h, p = n(a).children("tr"),
        g = function(e, a, t) {
          for (var n = e[a]; n[t];) t++;
          return t
        };
    ...
    function B(e, a, t) {
      ...
      for (var s = 0, o = t.length; o > s; s++)
        for (var l = 0, r = t[s].length; r > l; l++) !t[s][l].unique || n[l] && e.bSortCellsTop || (n[l] = t[s][l].cell);
      return n
    }
    ...
    function U(e) {
      var a, t, n, s, o, l = e.aoColumns.length,
        r = [];
      for (r.push({
          name: "sEcho",
          value: e.iDraw
      ...
      if (e.oFeatures.bSort !== !1) {
        ...
        for (t = null !== e.aaSortingFixed ? e.aaSortingFixed.concat(e.aaSorting) : e.aaSorting.slice(), s = 0; s < t.length; s++)
          for (n = e.aoColumns[t[s][0]].aDataSort, o = 0; o < n.length; o++) r.push({
            name: "iSortCol_" + i,
            value: n[o]
          }), r.push({
            name: "sSortDir_" + i,
    ...
    function j(e) {
      for (var a = Ra.ext.afnFiltering, t = h(e, "bSearchable"), n = 0, s = a.length; s > n; n++)
        for (var o = 0, l = 0, r = e.aiDisplay.length; r > l; l++) {
          var i = e.aiDisplay[l - o],
            u = a[n](e, y(e, i, "filter", t), i);
    ...
    function X(e, a, t, n, s, o) {
      var l, r = q(a, n, s, o),
        i = e.oPreviousSearch;
      if (t || (t = 0), 0 !== Ra.ext.afnFiltering.length && (t = 1), a.length <= 0) e.aiDisplay.splice(0, e.aiDisplay.length), e.aiDisplay = e.aiDisplayMaster.slice();
      else if (e.aiDisplay.length == e.aiDisplayMaster.length || i.sSearch.length > a.length || 1 == t || 0 !== a.indexOf(i.sSearch))
        for (e.aiDisplay.splice(0, e.aiDisplay.length), G(e, 1), l = 0; l < e.aiDisplayMaster.length; l++) r.test(e.asDataSearch[l]) && e.aiDisplay.push(e.aiDisplayMaster[l]);
      else {
        var u = 0;
    ...
    function K(e, a) {
      var t = e.oScroll.bInfinite ? 1 : e._iDisplayStart + 1,
        n = e.fnFormatNumber(t),
        s = e.fnDisplayEnd(),
        o = e.fnFormatNumber(s),
        l = e.fnRecordsDisplay(),
        r = e.fnFormatNumber(l),
        i = e.fnRecordsTotal(),
        u = e.fnFormatNumber(i);
    ...
    function ta(e) {
      ...
      var t, s, o = 'style="width: 56px;padding: 6px;" name="' + e.sTableId + '_length"',
        l = '<select size="1" ' + o + ">",
        r = e.aLengthMenu;
      if (2 == r.length && "object" == typeof r[0] && "object" == typeof r[1])
        for (t = 0, s = r[0].length; s > t; t++) l += '<option value="' + r[0][t] + '">' + r[1][t] + "</option>";
      else
        for (t = 0, s = r.length; s > t; t++) l += '<option value="' + r[t] + '">' + r[t] + "</option>";
      l += "</select>";
      var i = a.createElement("div");
    ...
    function oa(e, a) {
      ...
      else Ia(e, 0, "Unknown paging action: " + a);
    ...
    function ra(e, a) {
      if (e.oFeatures.bProcessing)
        for (var t = e.aanFeatures.r, s = 0, o = t.length; o > s; s++) t[s].style.visibility = a ? "visible" : "hidden";
    ...
    function ia(e) {
      ...
      var t = a.createElement("div"),
        ...
        f = 0 === e.nTable.getElementsByTagName("tfoot").length ? null : e.nTable.getElementsByTagName("tfoot")[0],
        h = e.oClasses;
    ...
    function ua(e) {
      var a, t, s, o, l, r, i, u, c, f, h, p = e.nScrollHead.getElementsByTagName("div")[0],
        g = p.getElementsByTagName("table")[0],
        b = e.nTable.parentNode,
        S = [],
        C = [],
        D = null !== e.nTFoot ? e.nScrollFoot.getElementsByTagName("div")[0] : null,
        m = null !== e.nTFoot ? D.getElementsByTagName("table")[0] : null,
        y = e.oBrowser.bScrollOversize,
        v = function(e) {
    ...
    function fa(e) {
      var t, s, o, l, r = (e.nTable.offsetWidth, 0),
        i = 0,
        u = e.aoColumns.length,
        d = n("th", e.nTHead),
        c = e.nTable.getAttribute("width"),
        f = e.nTable.parentNode;
      ...
      if (u == d.length && 0 === r && i == u && "" === e.oScroll.sX && "" === e.oScroll.sY)
        for (s = 0; s < e.aoColumns.length; s++) t = n(d[s]).width(), null !== t && (e.aoColumns[s].sWidth = ba(t));
      else {
        var h = e.nTable.cloneNode(!1),
          p = e.nTHead.cloneNode(!0),
          g = a.createElement("tbody"),
    ...
    function Ca(e, a) {
      var s, o, l, r, i, u, d, f, h, p, g, b, S, C, D = [],
        m = [],
        y = Ra.ext.oSort,
        _ = e.aoData,
        x = e.aoColumns,
      ...
      for (s = 0; s < F.length; s++)
        for (p = x[F[s][0]].aDataSort, i = 0, u = p.length; u > i; i++) b = p[i], S = x[b].sType || "string", h = y[S + "-pre"], D.push({
          col: b,
          dir: F[s][1],
          index: F[s][2],
          type: S,
        ...
        for (s = 0; s < D.length; s++) {
          ...
          if (d = e.aoColumns[A].sSortDataType, Ra.ext.afnSortData[d]) {
            ...
            if (L.length === _.length)
              for (l = 0, r = _.length; r > l; l++) T(e, l, A, L[l]);
            else Ia(e, 0, "Returned data sort array (col " + A + ") is the wrong length")
          }
        }
        for (s = 0, o = e.aiDisplayMaster.length; o > s; s++) m[e.aiDisplayMaster[s]] = s;
        for (l = 0; l < D.length; l++)
          for (C = D[l], s = 0, o = _.length; o > s; s++) g = v(e, s, C.col, "sort"), _[s]._aSortData[C.col] = C.format ? C.format(g) : g;
        e.aiDisplayMaster.sort(w === D.length ? function(e, a) {
          var t, n, s, o, l, r = D.length,
            i = _[e]._aSortData,
            u = _[a]._aSortData;
          for (s = 0; r > s; s++)
            if (l = D[s], t = i[l.col], n = u[l.col], o = n > t ? -1 : t > n ? 1 : 0, 0 !== o) return "asc" === l.dir ? o : -o;
          ...
          var t, n, s, o, l, r = D.length,
            ...
            u = _[a]._aSortData;
          for (s = 0; r > s; s++)
            if (l = D[s], t = i[l.col], n = u[l.col], o = y[l.type + "-" + l.dir](t, n), 0 !== o) return o;
          return t = m[e], n = m[a], n > t ? -1 : t > n ? 1 : 0
        })
      }
      for (a !== t && !a || e.oFeatures.bDeferRender || ma(e), s = 0, o = e.aoColumns.length; o > s; s++) {
        ...
        if (f = x[s].nTh, f.removeAttribute("aria-sort"), f.removeAttribute("aria-label"), x[s].bSortable)
          ...
          } else f.setAttribute("aria-label", R + ("asc" == x[s].asSorting[0] ? I.sSortAscending : I.sSortDescending));
        else f.setAttribute("aria-label", R)
      }
    ...
    function ma(e) {
      var a, t, s, o, l, r, i = e.aoColumns.length,
        u = e.oClasses;
    ...
    function Ta(e) {
      for (var a = 0; a < Ra.settings.length; a++)
        if (Ra.settings[a].nTable === e) return Ra.settings[a];
      return null
    }
    ...
    Ra = function(e) {
      ...
      this.$ = function(e, a) {
        ...
        if (a || (a = {}), a = n.extend({}, {
          ...
          for (t = r._iDisplayStart, s = r.fnDisplayEnd(); s > t; t++) o = i[u[t]].nTr, o && l.push(o);
        else if ("current" == a.order && "none" == a.filter)
          for (t = 0, s = d.length; s > t; t++) o = i[d[t]].nTr, o && l.push(o);
        else if ("current" == a.order && "applied" == a.filter)
          for (t = 0, s = u.length; s > t; t++) o = i[u[t]].nTr, o && l.push(o);
        else if ("original" == a.order && "none" == a.filter)
          for (t = 0, s = i.length; s > t; t++) o = i[t].nTr, o && l.push(o);
        else if ("original" == a.order && "applied" == a.filter)
          for (t = 0, s = i.length; s > t; t++) o = i[t].nTr, -1 !== n.inArray(t, u) && o && l.push(o);
        else Ia(r, 1, "Unknown selection options");
        var c = n(l),
          f = c.filter(e),
          h = c.find(e);
        ...
        var s, o, l = Ta(this[Ra.ext.iApiIndex]),
          r = l.nTableWrapper.parentNode,
          i = l.nTBody;
        if (a = a === t ? !1 : a, l.bDestroying = !0, La(l, "aoDestroyCallback", "destroy", [l]), !a)
          for (s = 0, o = l.aoColumns.length; o > s; s++) l.aoColumns[s].bVisible === !1 && this.fnSetColumnVis(s, !0);
        for (n(l.nTableWrapper).find("*").andSelf().unbind(".DT"), n("tbody>tr>td." + l.oClasses.sRowEmpty, l.nTable).parent().remove(), l.nTable != l.nTHead.parentNode && (n(l.nTable).children("thead").remove(), l.nTable.appendChild(l.nTHead)), l.nTFoot && l.nTable != l.nTFoot.parentNode && (n(l.nTable).children("tfoot").remove(), l.nTable.appendChild(l.nTFoot)), l.nTable.parentNode.removeChild(l.nTable), n(l.nTableWrapper).remove(), l.aaSorting = [], l.aaSortingFixed = [], ma(l), n(_a(l)).removeClass(l.asStripeClasses.join(" ")), n("th, td", l.nTHead).removeClass([l.oClasses.sSortable, l.oClasses.sSortableAsc, l.oClasses.sSortableDesc, l.oClasses.sSortableNone].join(" ")), l.bJUI && (n("th span." + l.oClasses.sSortIcon + ", td span." + l.oClasses.sSortIcon, l.nTHead).remove(), n("th, td", l.nTHead).each(function() {
            var e = n("div." + l.oClasses.sSortJUIWrapper, this),
              a = e.contents();
        ...
        if (u.oFeatures.bFilter)
          if ((o === t || null === o) && (o = !1), (l === t || null === l) && (l = !0), (r === t || null === r) && (r = !0), (i === t || null === i) && (i = !0), s === t || null === s) {
            if (O(u, {
              ...
              for (var d = u.aanFeatures.f, c = 0, f = d.length; f > c; c++) try {
        ...
        for (var a = Ta(this[Ra.ext.iApiIndex]), t = (a.aoOpenRows, 0); t < a.aoOpenRows.length; t++)
          if (a.aoOpenRows[t].nParent == e) return !0;
        return !1
      }, this.fnOpen = function(e, t, s) {
        var o = Ta(this[Ra.ext.iApiIndex]),
          l = _a(o);
        if (-1 !== n.inArray(e, l)) {
          this.fnClose(e);
          var r = a.createElement("tr"),
          ...
          var u = n("tr", o.nTBody);
          return -1 != n.inArray(e, u) && n(r).insertAfter(e), o.aoOpenRows.push({
            nTr: r,
            nParent: e
          }), r
        }
        ...
        var s, o, l, r, i, d = Ta(this[Ra.ext.iApiIndex]),
          c = d.aoColumns,
          h = d.aoData;
        if (c[e].bVisible != a) {
          if (a) {
            ...
            for (s = 0, o = h.length; o > s; s++) null !== h[s].nTr && (l = xa(d, s)[e], h[s]._anHidden[e] = l, l.parentNode.removeChild(l));
        ...
        var r, i, d = Ta(this[Ra.ext.iApiIndex]),
          c = "object" == typeof a ? D(d, a) : a;
        if (s === t || null === s)
          for (d.aoData[c]._aData = e, r = 0; r < d.aoColumns.length; r++) this.fnUpdate(v(d, c, r), c, r, !1, !1);
        else {
      ...
      return this.each(function() {
        ...
        var y = D.asStripeClasses; - 1 !== n.inArray(!0, n.map(y, function(e) {
        ...
        if (0 !== _.length && (H(D.aoHeader, _[0]), T = B(D)), null === e.aoColumns)
          for (v = [], c = 0, s = T.length; s > c; c++) v.push(null);
        else v = e.aoColumns;
        ...
        if (0 === A.length && I.length > 0 && ("" !== D.oScroll.sX || "" !== D.oScroll.sY) && (A = [a.createElement("tfoot")], this.appendChild(A[0])), A.length > 0 && (D.nTFoot = A[0], H(D.aoFooter, D.nTFoot)), p)
          for (c = 0; c < e.aaData.length; c++) S(D, e.aaData[c]);
        else(D.bDeferLoading || null === D.sAjaxSource) && C(D, n(D.nTBody).children("tr"));
      ...
      for (var a, t, n = Ra.ext.sVersion.split("."), s = e.split("."), o = 0, l = s.length; l > o; o++)
        if (a = parseInt(n[o], 10) || 0, t = parseInt(s[o], 10) || 0, a !== t) return a > t;
      return !0
    }, Ra.fnIsDataTable = function(e) {
      for (var a = Ra.settings, t = 0; t < a.length; t++)
        if (a[t].nTable === e || a[t].nScrollHead === e || a[t].nScrollFoot === e) return !0;
      return !1
      ...
      oLanguage: {
        ...
        sEmptyTable: "Dados não Avaliados",
        sInfo: "Inicio _START_ de _END_ ate _TOTAL_ lista",
        sInfoEmpty: "Inicio 0 de 0 ate 0 lista",
        sInfoFiltered: "(filtered from _MAX_ total entries)",
        sInfoPostFix: "",
        sInfoThousands: ",",
        sLengthMenu: "Opções _MENU_ ",
      ...
      two_button: {
        fnInit: function(e, a, t) {
          ...
          e.oApi._fnBindAction(i, {
            ...
            action: "next"
          }, o), e.aanFeatures.p || (a.id = e.sTableId + "_paginate", i.id = e.sTableId + "_previous", u.id = e.sTableId + "_next", i.setAttribute("aria-controls", e.sTableId), u.setAttribute("aria-controls", e.sTableId))
        },
        fnUpdate: function(e) {
          if (e.aanFeatures.p)
            for (var a, t = e.oClasses, n = e.aanFeatures.p, s = 0, o = n.length; o > s; s++) a = n[s].firstChild, a && (a.className = 0 === e._iDisplayStart ? t.sPagePrevDisabled : t.sPagePrevEnabled, a = a.nextSibling, a.className = e.fnDisplayEnd() == e.fnRecordsDisplay() ? t.sPageNextDisabled : t.sPageNextEnabled)
        }
      },
      ...
      full_numbers: {
        fnInit: function(e, a, t) {
          ...
          e.oApi._fnBindAction(i, {
            action: "primeiro"
          }, l), e.oApi._fnBindAction(u, {
            action: "prever"
          }, l), e.oApi._fnBindAction(d, {
            action: "proximo"
          }, l), e.oApi._fnBindAction(c, {
            action: "voltar"
          }, l), e.aanFeatures.p || (a.id = e.sTableId + "_paginate", i.id = e.sTableId + "_first", u.id = e.sTableId + "_previous", d.id = e.sTableId + "_next", c.id = e.sTableId + "_last")
        },
        fnUpdate: function(e, a) {
          if (e.aanFeatures.p) {
            var t, s, o, l, r, i, u, d = Ra.ext.oPagination.iFullNumbersShowPages,
              c = Math.floor(d / 2),
              f = Math.ceil(e.fnRecordsDisplay() / e._iDisplayLength),
